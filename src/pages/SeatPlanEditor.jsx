...
import { getRewardConfigStats } from '../api/makeSeatList/seatPlanActions';
import { createSeatPlanEditorHandlers } from '../api/makeSeatList/seatPlanEditorActions';
                ...
                <div style={{ display: 'flex', flexDirection: 'column', height: '100%', minHeight: 0, overflow: 'hidden' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, flexShrink: 0 }}>
                        ...
                        <Space>
                            ...
                            >
                                {activeProfileId ? `将更改保存到此档案${activeProfileName ? `（${activeProfileName}）` : ''}` : '将更改保存到此档案'}
                            </Button>
                            <Button
